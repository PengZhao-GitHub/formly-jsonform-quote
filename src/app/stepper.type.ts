    ...
    <mat-horizontal-stepper>
      <mat-step *ngFor="let step of field.fieldGroup; let index = index; let last = last">
        ...
        <div class="form-buttons">
          <button matStepperPrevious *ngIf="index !== 0" mat-raised-button color="primary" type="button">Back</button>

          <button matStepperNext *ngIf="!last" mat-raised-button color="primary" type="button" [disabled]="!isValid(step)">
            Next
          </button>
